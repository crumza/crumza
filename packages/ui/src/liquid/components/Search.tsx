...
export function LiquidSearch({ radius = LIQUID_RADIUS }: LiquidComponentProps): ReactElement {
  ...
  /* A press on the bare glass must not steal focus from the field, or the blur
     above would fold the bar the moment it is touched. Cancelling the
     pointerdown stops the focus change; the clicks still run. */
