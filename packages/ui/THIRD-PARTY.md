...
The liquid glass set (src/liquid) draws its small glyphs (about thirty) whose path data is taken from Lucide (ISC licence, Copyright (c) for portions of Lucide are held by Cole Bemis 2013-2022 as part of Feather (MIT), all other copyright (c) for Lucide are held by Lucide Contributors 2022). They are inlined in src/liquid/core/icons.tsx so no icon runtime is a dependency. The Lucide licence text is at https://github.com/lucide-icons/lucide/blob/main/LICENSE. The website's five liquid scene images under apps/website/public/liquid are the owner's own assets and two authored SVG gradients; no watermarked or stock-licensed preview image is bundled.
