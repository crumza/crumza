...
const groups: readonly { readonly heading: string; readonly items: readonly string[] }[] = [
  ...
  { heading: 'Surfaces', items: ['Context menu', 'Sheet'] },
...
const entries: Record<string, Entry> = {
  ...
  Sheet: {
    title: 'A sheet from the foot',
    component: 'LiquidSheet',
    href: 'liquid-sheet',
    render: (r) => <LiquidSheet radius={r} />,
  },
  'Plus button': {
    title: 'A plus that opens up',
    component: 'LiquidPlusButton',
    href: 'liquid-plus-button',
    render: (r) => <LiquidPlusButton radius={r} />,
  },
  'Menu button': {
    title: 'Three bars, then a menu',
    component: 'LiquidMenuButton',
    href: 'liquid-menu-button',
    render: (r) => <LiquidMenuButton radius={r} />,
  },
  'Action pill': {
    title: 'A round that pours out',
    component: 'LiquidActionPill',
    href: 'liquid-action-pill',
    render: (r) => <LiquidActionPill radius={r} />,
  },
  'Action dock': {
    title: 'Actions from behind',
    component: 'LiquidActionDock',
    href: 'liquid-action-dock',
    render: (r) => <LiquidActionDock radius={r} />,
  },
  'Context toolbar': {
    title: 'A bar out of its icon',
    component: 'LiquidContextToolbar',
    href: 'liquid-context-toolbar',
    render: (r) => <LiquidContextToolbar radius={r} />,
  },
  'Command palette': {
    title: 'A button that listens',
    component: 'LiquidCommandPalette',
    href: 'liquid-command-palette',
    render: (r) => <LiquidCommandPalette radius={r} />,
  },
  Gallery: {
